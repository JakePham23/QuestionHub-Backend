...
class PostgreSQLDatabase {
    ...
    async _connect() {
          this.pool = new Pool({
            ...
            // The application should fail to start if these are not defined,
            // rather than using insecure defaults.
            ...
            // For production, require SSL and verify the server certificate.
            // `rejectUnauthorized: false` makes you vulnerable to man-in-the-middle attacks.
